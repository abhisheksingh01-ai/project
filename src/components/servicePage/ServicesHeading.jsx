// components/services/ServicesHeading.jsx
...
export default function ServicesHeading({
  ...
  return (
    <div className="w-full text-center mb-16 relative">
      ...
      <h2
        className="mx-auto text-3xl md:text-5xl lg:text-6xl xl:text-[72px] font-[Urbanist] font-extrabold text-[#0C0C0C] leading-tight
      ...
      <style>{`
        ...
        /* ensure underline (absolute) stays positioned relative to the h2 container */
        .animate-slideUp + span { /* no-op to avoid accidental selector collapse */ }
      `}</style>
    </div>
  );
}
