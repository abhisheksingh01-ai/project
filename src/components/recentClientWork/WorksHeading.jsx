// components/works/WorksHeading.jsx
...
export default function WorksHeading() {
  return (
    <div className="w-full text-center mb-16 relative">
      ...
      {/* Eyebrow with symmetric animated lines */}
      ...
      <p className="mt-8 text-base md:text-lg text-[#4A4A4A] max-w-3xl mx-auto font-inter px-4">
        Premium projects across industries — interactive websites, apps and
        campaigns that drove measurable results.
      </p>
